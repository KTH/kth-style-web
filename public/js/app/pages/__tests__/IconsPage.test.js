      ...
      >
        ...
        >
          ...
          >
            <div
              class="itemBox"
              style="background-image: url(/style/static/kth-style/img/kth-style/icons/arrow-long-black-right.svg); background-size: 30px 30px; background-repeat: no-repeat; margin: 20px auto auto auto; background-position: center;"
            />
            <div
              class="displayName"
            >
              ...
              >
                <pre>
                  <code
                    class="language-html"
                  >
                    url(/style/static/kth-style/img/kth-style/icons/arrow-long-black-right.svg)
                  </code>
                </pre>
                <div
                  class="code-snippet__btn-container"
          ...
          >
            <div
              class="itemBox"
              style="background-image: url(/style/static/kth-style/img/kth-style/icons/arrow-long-white-right.svg); background-size: 30px 30px; background-repeat: no-repeat; background-color: rgb(101, 101, 108); margin: 20px auto auto auto; background-position: center;"
            />
            <div
              class="displayName"
            >
              ...
              >
                <pre>
                  <code
                    class="language-html"
                  >
                    url(/style/static/kth-style/img/kth-style/icons/arrow-long-white-right.svg)
                  </code>
                </pre>
                <div
                  class="code-snippet__btn-container"
          ...
          >
            <div
              class="itemBox"
              style="background-image: url(/style/static/kth-style/img/kth-style/icons/arrow-long-blue-right.svg); background-size: 30px 30px; background-repeat: no-repeat; margin: 20px auto auto auto; background-position: center;"
            />
            <div
              class="displayName"
            >
              ...
              >
                <pre>
                  <code
                    class="language-html"
                  >
                    url(/style/static/kth-style/img/kth-style/icons/arrow-long-blue-right.svg)
                  </code>
                </pre>
                <div
                  class="code-snippet__btn-container"
          ...
          >
            <div
              class="itemBox"
              style="background-image: url(/style/static/kth-style/img/kth-style/icons/arrow-long-blue-left.svg); background-size: 30px 30px; background-repeat: no-repeat; margin: 20px auto auto auto; background-position: center;"
            />
            <div
              class="displayName"
            >
              ...
              >
                <pre>
                  <code
                    class="language-html"
                  >
                    url(/style/static/kth-style/img/kth-style/icons/arrow-long-blue-left.svg)
                  </code>
                </pre>
                <div
                  class="code-snippet__btn-container"
